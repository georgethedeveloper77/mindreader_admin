          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/sub_admin/add')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20 mt-2" data-toggle="tooltip" title="{{trans('words.add_admin')}}"><i class="fa fa-plus"></i> {{trans('words.add_admin')}}</a>
                </div>
              </div>
