            ...
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>{{trans('words.section_title')}}</th>
                  ...
                  <tbody>
                   @foreach($list as $i => $data)
                    <tr id="card_box_id_{{$data->id}}">
                      ...
                      <a href="{{ url('admin/home_sections/edit/'.$data->id) }}" class="btn btn-icon waves-effect waves-light btn-success m-b-5 m-r-5" data-toggle="tooltip" title="{{trans('words.edit')}}"> <i class="fa fa-edit"></i> </a>

                      <a href="#" class="btn btn-icon waves-effect waves-light btn-danger m-b-5 data_remove" data-toggle="tooltip" title="{{trans('words.remove')}}" data-id="{{$data->id}}"> <i class="fa fa-remove"></i> </a>
