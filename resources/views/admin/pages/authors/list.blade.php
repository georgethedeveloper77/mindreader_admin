          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="row">
                 <div class="col-md-3">
                     {!! Form::open(array('url' => 'admin/authors','class'=>'app-search','id'=>'search','role'=>'form','method'=>'get')) !!}   
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/authors/add')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20 mt-2 pull-right" data-toggle="tooltip" title="{{trans('words.add_author')}}"><i class="fa fa-plus"></i> {{trans('words.add_author')}}</a>
                </div>
              </div>
                  ...
                  @foreach($list as $i => $data)
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6" id="card_box_id_{{$data->id}}">
                        ...
                        <div class="card m-b-20">
                            ...
                            @if(isset($data->image)) <img class="card-img-top thumb-md img-fluid" src="{{URL::to('/'.$data->image)}}" alt="{{ stripslashes($data->name) }}"> @endif
 

                            <div class="card-body p-3">
                                <h4 class="card-title mb-3">{{ stripslashes($data->name) }}</h4>
                                
                                <a href="{{ url('admin/authors/edit/'.$data->id) }}" class="btn btn-icon waves-effect waves-light btn-success m-r-5" data-toggle="tooltip" title="{{trans('words.edit')}}"> <i class="fa fa-edit"></i> </a>
