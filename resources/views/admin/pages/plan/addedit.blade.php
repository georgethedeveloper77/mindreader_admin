          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                 ...
                 {!! Form::open(array('url' => array('admin/subscription_plan/add_edit'),'class'=>'form-horizontal','name'=>'slider_form','id'=>'slider_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
